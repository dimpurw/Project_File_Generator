    ...
    <div class="container">
        <div class="row">
            <div class="col mb-3">
                ...
                <div class="media surat mt-5" id="listSurat2" style="background-color: white; border: 1px solid #D5D3D3; box-sizing: border-box; border-radius: 4px; border-left-width:10px; border-left-color: #9FB7FF;">
