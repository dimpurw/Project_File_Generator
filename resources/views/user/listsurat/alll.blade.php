       ...
       <!--  Konten surat -->
                ...
                <!-- semua surat -->    
                 @if (isset($datasurat) && count($datasurat) > 0)
                  ...
                  <?php 
                   ...
                   ?>
                <div role="tabpanel" @if($jenis == 'Perusahaan') class="tab-pane active pb-4" id="{{$surat->JenisSurat}}" aria-labelledby="{{$surat->JenisSurat}}-tab" aria-expanded="true" @endif ($jenis == 'Internal') class="tab-pane pb-4" id="{{$surat->JenisSurat}}" aria-labelledby="{{$surat->JenisSurat}}-tab" aria-expanded="false" >
        ...
        <div class="col-md-1" >
           <button type="button" class="btn btn-floating btn-lg" id="btn-back-to-top" data-toggle="modal" data-target="#exampleModalCenter" style="background-color: #4D6EFF; color: white;"> <i class="fa fa-plus-circle fa-2x" style="align-items: center;">
            ...
            <a href="#perusahaan" class="nav-link active" id="perusahaan-tab" data-toggle="tab" data-target="#perusahaan"  role="tab" aria-controls="perusahaan" aria-selected="false" style="border-radius:0px">
            Perusahaan</a></li>
