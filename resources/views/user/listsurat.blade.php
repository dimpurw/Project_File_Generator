...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-warning" style="height: 50px;">
            ...
            <div class="col-5">
                <div class="list-rigth">
                    <div class="list-group mt-5" id="list-tab" role="tablist" style="width: 10rem; text-align: right;">
                        ...
                        <a class="list-group-item list-group-item-action" id="list-settings-list" style="border-radius: 10px;" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">Settings</a>
                    </div>
                </div>
            </div>
        </div>
